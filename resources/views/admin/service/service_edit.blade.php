                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="{{route('update.service', $service->id)}}" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input name="service_title" value="{{$service->service_title}}" class="form-control" type="text" id="service_title">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input name="service_icon" value="{{$service->service_icon}}" class="form-control" type="text" id="service_icon">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input name="service_description" value="{{$service->service_description}}" class="form-control" type="text" id="service_description">
                                </div>
                            </div>
